...
const Contact = () => {
    ...
    formData.append("access_key", "0f9c7b8a-204b-4fc0-86b9-66b7b6489c15");
                ...
                <div className="contact-left">
                    ...
                    <div className="contact-details">
                        <div className="contact-detail">
                            <img src={mail_icon} alt="" /> <p>lanskyyit@gmail.com</p>
                        </div>
                        <div className="contact-detail">
                            <img src={call_icon} alt="" /> <p>+0895-0659-6698</p>
                        </div>
                        <div className="contact-detail">
                            <img src={location_icon} alt="" /> <p>Surabaya,Indonesia</p>
                        </div>
                    </div>
                </div>
